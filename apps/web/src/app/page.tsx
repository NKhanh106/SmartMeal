...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white text-slate-900">
          ...
          >
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                SmartMeal uses AI to analyze your meals, track your nutrients,
                and suggest personalized workout plans. All in one simple
                dashboard.
              </p>
      ...
      <footer className="w-full py-12 border-t bg-white text-slate-600">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-8 lg:grid-cols-4">
            <div className="space-y-4">
              <div className="flex items-center">
                <Zap className="h-6 w-6 text-primary mr-2" />
                <span className="font-bold text-slate-900 text-xl">SmartMeal</span>
              </div>
              <p className="text-sm text-slate-500">
                Empowering health through data and AI analysis.
              </p>
            </div>
            <div>
